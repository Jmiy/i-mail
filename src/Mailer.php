...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @param  string  $name
     * @param  Hyperf\ViewEngine\Contract\FactoryInterface  $views
     ...
     *
     * @param  \Illuminate\Mail\Contracts\Mailable|string|array  $view
     * @param  array  $data
     ...
     *
     * @param  string  $queue
     * @param  \Illuminate\Mail\Contracts\Mailable  $view
     * @return mixed
     */
